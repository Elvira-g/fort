        ...
        <div class="container">
            <nav class="nav">
                ...
                <div class="menu-block">
                    <ul class="menu-list">
                        <li class="menu-item"><a href="#price" class="menu-item-link" data-tr="price"></a></li>
                        <!-- <li class="menu-item"><a href="#benefits" class="menu-item-link">Преимущества</a></li> -->
                        <li class="menu-item"><a href="#equipment" class="menu-item-link" data-tr='services'></a></li>
                        <li class="menu-item"><a href="#about" class="menu-item-link" data-tr='about'></a></li>
                        <li class="menu-item"><a href="#contacts" class="menu-item-link" data-tr='contacts'></a></li>
                    </ul>
                    <div class="container">
                        <button class="btn-main call-btn nav-btn-mob" data-tr='call-btn'></button>
                    </div>
                </div>
                <div class="lang-block">
                    <img src="./assets/img/ru.png" alt="" class="lang-block-link lang-ru" data-lang='ru'>
                    <img src="./assets/img/ar.png" alt="" class="lang-block-link lang-am lang-active" data-lang='am'>
                </div>
                <div class="call-block">
                    <p class="call-number" data-tr='phone'>+7 495 877-47-39</p>
                    <button class="btn-main call-btn nav-btn" data-tr='call-btn'></button>
                </div>
            ...
            <div class="container">
                ...
                <div class="price-items-block">
                    <div class="price-item price-item-prices">
                        ...
                        <div class="price-item-number-block">
                            <p class="price-item-number" data-tr='rates-flat-number'>1 000</p>
                            <table class="price-number-text">
                                <tr>
                    ...
                    <div class="price-item price-item-prices">
                        ...
                        <div class="price-item-number-block">
                            <p class="price-item-number" data-tr='rates-house-number'>2 000</p>
                            <table class="price-number-text">
                                <tr>
                                    <td data-tr='currency'>руб.</td>
                                </tr>
                    ...
                    <div class="price-item price-item-prices">
                        ...
                        <div class="price-item-number-block">
                            <p class="price-item-number" data-tr='rates-busines-number'>4 500</p>
                            <table class="price-number-text">
                                <tr>
                                    <td data-tr='currency'>руб.</td>
                                </tr>
            ...
            <div class="container">
                ...
                <div class="equipment-items-block">
                    <div class="equipment-item">
                        ...
                        <p class="equipment-item-price" data-tr='alarm-price'>9 050</p>
                    ...
                    <div class="equipment-item">
                        ...
                        <p class="equipment-item-price" data-tr='button-price'>6 000</p>
                        <p class="equipment-item-currency" data-tr='currency'>руб.</p>
                        <button class="btn-main equipment-btn call-btn" data-tr='buy-btn'>Купить систему</button>
                    </div>
                    <div class="equipment-item">
                        ...
                        <p class="equipment-item-price" data-tr='combo-price'>10 080</p>
                        <p class="equipment-item-currency" data-tr='currency'>руб.</p>
                        <button class="btn-main equipment-btn call-btn" data-tr='buy-btn'>Купить систему</button>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="footer-items-block">
                <div class="footer-logo-block">
                    ...
                    <p class="footer-phone" data-tr='phone'>+7 (495) 877-47-39</p>
                    <p class="footer-phone" data-tr='email'>sales2@uvo-ohrana.ru</p>
                </div>
